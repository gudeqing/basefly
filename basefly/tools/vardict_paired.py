...
def VardictPaired():
    ...
    cmd.args['nosv'] = Argument(prefix='--nosv', type='bool', default=True, desc='Turn off structural variant calling.')
    ...
    cmd.args['names'] = Argument(prefix='-N ', array=True, delimiter='\\|', desc='The tumor and normal sample name(s).  If only one name is given, the matched will be simply names as "name-match".')
