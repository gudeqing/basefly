...
def prepare_quantiseq_input():
    ...
    cmd.args['expr'] = Argument('-expr ', type='infile', desc='input salmon quan.gene.sf')
    cmd.args['id2name'] = Argument('-id2name ', type='infile', default='/opt/quantiseq/deconvolution/TIL10_signature_symbol_converstion.txt', desc='file with two column: gene_id gene_name_accepted_by_quantiseq')
    cmd.args['sample_name'] = Argument('-sample_name ', desc='sample name')
