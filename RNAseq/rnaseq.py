...
def star(sample, platform='illumina'):
    ...
    cmd.args["limitIObufferSize"] = Argument(prefix="--limitIObufferSize ", default=150000000, desc="int>0: max available buffers size (bytes) for input/output, per thread")
    ...
    cmd.args["chimOutType"] = Argument(prefix="--chimOutType ", default='WithinBAM', desc="type of chimeric output")
